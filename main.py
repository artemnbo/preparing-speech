...
print(78, translit(num2words(78), 'ru'), sep=separator)
print(15, translit(num2words(15), 'ru'), sep=separator)
print(3, translit(num2words(3), 'ru'), sep=separator)
print(40, translit(num2words(40), 'ru'), sep=separator)
print(8, translit(num2words(8), 'ru'), sep=separator)